      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <form className="panel space-y-4 p-4" onSubmit={saveVerification}>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <label className="form-label">Urgent referral<select className="form-control" name="urgentReferralStatus" defaultValue="">{answers.map(([value, label]) => <option key={value} value={value}>{label}</option>)}</select></label>
