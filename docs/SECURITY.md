...
- The application creates request correlation IDs unless a trusted proxy is explicitly configured to replace them. Metric labels use fixed operational categories and contain no user/provider identifiers.
